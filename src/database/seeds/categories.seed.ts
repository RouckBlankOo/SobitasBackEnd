export const categoriesSeedData = [
  {
    ...
    slug: 'proteines',
    description:
      'Toutes les protéines pour la construction musculaire et la récupération',
    active: true,
    order: 1,
    featured: true,
  },
  {
    ...
    slug: 'pre-workout',
    description:
      'Suppléments pré-entraînement pour énergie et performance maximales',
    active: true,
    order: 2,
    featured: true,
  },
...
export const subcategoriesSeedData = [
  ...
  {
    designation: 'Vegan Protein',
    designation_fr: 'Protéine Végétale',
    slug: 'vegan-protein',
    category: 'Protéines',
    order: 3,
    active: true,
  ...
  {
    designation: 'Stimulant Pre-Workout',
    designation_fr: 'Pre-Workout Stimulant',
  ...
  {
    designation: 'Non-Stimulant Pre-Workout',
    designation_fr: 'Pre-Workout Non-Stimulant',
    slug: 'non-stimulant-pre-workout',
    category: 'Pre-Workout',
    order: 2,
    active: true,
  },
  ...
  {
    designation: 'Monohydrate',
    designation_fr: 'Monohydrate',
    slug: 'monohydrate',
    category: 'Créatine',
    order: 1,
    active: true,
  ...
  {
    designation: 'Mass Gainer',
    designation_fr: 'Mass Gainer',
    slug: 'mass-gainer',
    category: 'Gainers',
    order: 1,
    active: true,
  ...
  {
    designation: 'Thermogenic',
    designation_fr: 'Thermogénique',
    slug: 'thermogenic',
  ...
  {
    designation: 'Multivitamins',
    designation_fr: 'Multivitamines',
    slug: 'multivitamins',
    category: 'Vitamines',
    order: 1,
    active: true,
